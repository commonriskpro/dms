...
const defaultContentClass =
  "glass-elevated relative z-50 w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-[24px] border border-[var(--glass-border)] bg-[var(--glass-bg-strong)] text-[var(--text)] p-4";
