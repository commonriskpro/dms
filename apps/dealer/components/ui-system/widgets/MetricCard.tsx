...
function MetricBody({
  ...
  return (
    <div className="space-y-2.5">
      ...
      {delta ? (
        <div className="inline-flex min-h-6 items-center rounded-[var(--radius-pill)] border border-[var(--border)] bg-[var(--surface-2)] px-2.5 text-xs font-medium text-[var(--muted-text)]">
          {delta}
        </div>
      ) : null}
