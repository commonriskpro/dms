...
export function ModuleNotIncludedPanel({
  ...
  return (
    <div className="glass-surface rounded-[var(--radius-card)] border border-[var(--glass-border)] bg-[var(--glass-bg)] p-8 text-center">
      <div className="glass-field mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-[var(--glass-border)] bg-[var(--glass-bg)] text-[var(--muted-text)]">
        <CircleAlert size={24} />
      </div>
      ...
      {showSettingsLink && (
        <div className="mt-4">
          <Link
            href="/settings"
            className="glass-field inline-flex items-center justify-center font-medium border border-[var(--glass-border)] px-4 py-2 text-sm rounded-md bg-[var(--glass-bg)] text-[var(--text)] hover:bg-[var(--glass-bg-strong)] transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--ring)] focus-visible:ring-offset-0"
          >
            Go to Settings
          </Link>
        </div>
