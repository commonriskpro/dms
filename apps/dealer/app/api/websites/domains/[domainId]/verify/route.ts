...
/**
 * POST /api/websites/domains/[domainId]/verify — refresh domain verification status.
 */
export async function POST(
  ...
  try {
    ...
    const updated = await domainsService.refreshDomainVerification(ctx.dealershipId, domainId);
