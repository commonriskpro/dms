...
/**
 * Handles both /inventory/[id] (vehicle detail) and /inventory/list.
 * The static list/page.tsx takes priority when the route cache is warm;
 * this guard ensures /inventory/list works even when the static route
 * isn't registered (e.g. native app window without a cache rebuild).
 */
