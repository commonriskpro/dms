...
type SectionId = "profile" | "dealership" | "users-roles" | "notifications" | "security" | "integrations";
...
export default function SettingsPage() {
  ...
  const navLinkInactive = "text-[var(--muted-text)] hover:bg-[var(--surface-2)] hover:text-[var(--text)]";

  return (
    <PageShell className="space-y-4">
      <PageHeader
        title={<h1 className="text-[24px] font-semibold leading-tight text-[var(--text)]">Settings</h1>}
        actions={
          <>
