  ...
  return (
    <DMSCard className={cn("overflow-hidden", className)}>
      <div className="flex flex-col sm:flex-row">
        {/* Photo — fixed width, natural aspect */}
        <div className="relative w-full sm:w-56 shrink-0 bg-[var(--surface-2)] sm:border-r border-b sm:border-b-0 border-[var(--border)]">
                    ...
                    <div className="absolute bottom-2 left-1/2 -translate-x-1/2 flex gap-1">
                      {urls.map((_, i) => (
                        <button
                          ...
                          className={cn(
                            "w-1.5 h-1.5 rounded-full border border-[var(--border)]",
