...
| vinDecode | `vinDecode` | `/api/internal/jobs/vin-decode` | `modules/inventory/service/vin-followup.ts::runVinFollowUpJob` + `lib/internal-job-run.ts` | Medium | Medium | Medium | Optional after analytics/alerts |
