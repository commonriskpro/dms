/**
 * Cinematic demo generator — automated UI walkthrough driven by demo-scenes.
 * Executes each scene action with slow, cinematic transitions. Records to raw-demo.webm (1080p).
 */
...
import type { DemoSceneAction } from "./demo-scenes";
...
/** Convert scene duration (seconds) to ms; use for cinematic hold. */
...
export async function runDemo(): Promise<void> {
  ...
  try {
    ...
    // Run each scene: execute action then hold for duration (cinematic)
