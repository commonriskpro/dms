/**
 * Cinematic Demo Studio — generate narration script from scene registry.
 * Sections: Intro, Dashboard, Inventory workflow, CRM pipeline, Deal desk, Delivery workflow, Closing.
