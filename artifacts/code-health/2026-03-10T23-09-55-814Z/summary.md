...
Generated: 2026-03-10T23:10:13.389Z

## dealer
- tsconfig: `apps/dealer/tsconfig.json`
- total findings: **1544**
- actionable findings: **243**
...
- `apps/dealer/components/ui/dms-page.tsx:7 - DMSPage`
- `apps/dealer/components/ui/dms-page.tsx:19 - DMSSection`
...
- `apps/dealer/components/ui-system/navigation/index.ts:15 - SidebarItem`
