...
Generated: 2026-03-10T21:06:45.375Z

## dealer
- tsconfig: `apps/dealer/tsconfig.json`
- total findings: **2117**
- actionable findings: **964**
...
- `apps/dealer/components/ui/dms-row.tsx:20 - DMSRow`
...
- `apps/dealer/lib/api/index.ts:3 - incrementRateLimit`
- `apps/dealer/lib/api/index.ts:3 - getClientIdentifier`
- `apps/dealer/lib/api/index.ts:4 - validateQuery`
- `apps/dealer/lib/api/index.ts:4 - validateBody`
- `apps/dealer/lib/api/index.ts:4 - validateParams`
- `apps/dealer/lib/api/index.ts:4 - validationErrorResponse`
