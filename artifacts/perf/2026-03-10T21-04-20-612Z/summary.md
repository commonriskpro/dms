...
- Run ID: `2026-03-10T21-04-20-612Z`
- Started: 2026-03-10T21:04:20.612Z
- Finished: 2026-03-10T21:04:26.791Z
- Duration: 6179ms
...
|---|---|---:|---:|---|---|
| reports | passed | 0 | 1015 | salesSummary p95=0.45ms | `reports.log` |
| inventory | passed | 0 | 1196 | inventory total p95=10ms | `inventory.log` |
| dashboard | passed | 0 | 957 | dashboard p95=1ms errors=0 | `dashboard.log` |
| worker-burst | passed | 0 | 1456 | crmFailedEnqueueCount=0 | `worker-burst.log` |
| worker-bridge | skipped | 0 | 688 | skipped: DEALER_INTERNAL_API_URL not reachable (fetch failed) | `worker-bridge.log` |
